...
<head>
    ...
    <title><?=$title?></title>
    <meta name="google-site-verification" content="keDf6_aTLj-sCK4u9ssSsjmkiasqj6RrNMHWUtiliag" />
    <meta name="description" content="Bienvenue sur mon portfolio, vous pouvez visiter ici mes expériences personnelles et mes travaux et télécharger mon CV en version anglaise et française.">
    <meta name="keywords" content="ben salem rami, Ben Salem Rami, portofolio, Portfolio, cv, CV">
    <meta name="author" content="Ben Salem Rami">
    <meta name="robots" content="index, follow projects, resume, contact"> <!-- Dire ai motori di ricerca di indicizzare e seguire i link sulla pagina -->
    <!-- Favicon-->
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">Design &middot; Front-End &middot; Back-End</div>
                            </div>
                            <div class="fs-3 fw-light text-muted">Bienvenue sur mon portfolio</div>
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Bonne visite et bonne lecture.</span></h1>
                            <div
    ...
    <footer class="bg-white py-4 mt-auto">
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <div class="container">
                                <h2 class="mt-4">Qui suis-je? Ben Salem Rami</h2>
                                <p>Formé par CF2M en tant que développeur web full-stack.</p>
                                <p>Passionné de design et de programmation.</p>
                                
                              
                                
                                <h3 class="mt-4" style="color: rgb(221, 97, 31); margin-bottom: 10px;">Objectifs:</h3>
                                <ul>
                                    <p>Devenir un développeur web accompli
                                    Créer des sites web à la fois esthétiques et fonctionnels
                                    Collaborer au sein d'une équipe créative
                                    Progresser professionnellement</p>
                                </ul>
                            </div>
                            <div class="d-flex justify-content-center fs-2 gap-4">
                                
                                <a class="text-gradient" href="#!"><i class="bi bi-linkedin"></i></a>
                                <a class="text-gradient" target="_blank" href="https://github.com/rammroumm2K"><i class="bi bi-github"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                ...
                <div class="col-auto">
                    <a class="small" href="../">Accueil</a>
                    <span class="mx-1">&middot;</span>
                    <a class="small" href="../view/projects.php">Mes compétences</a>
                    <span class="mx-1">&middot;</span>
                    <a class="small" href="../view/resume.php">Mes travaux réalisés</a>
                </div>
            </div>
        </div>
    </footer>
